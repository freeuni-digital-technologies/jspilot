...
MESSAGES['inspect-element'] = `
    inspect element არის ბრაუზერის ფუნქცია საიტის html და css კოდის სანახავად. ამისთვის, საიტის ცარიელ ადგილას
    (ისე რომ ტექსტი, ლინკი ან სურათი არ იყოს კურსორის ქვეშ) გააკეთე right click და დააჭირე inspect-ს. აქ შეგიძლია
...
MESSAGES['კონსოლის-გამოყენება'] = `
    <p>შენს მიერ გახსნილ ფანჯარაში ქვემოთ ლურჯი > სიმბოლო არის. დააკლიკე მის მარჯვნივ, რომ ტექსტი შეიყვანო. როდესაც ინსტრუქციაში > სიმბოლოს დაინახავ, ეს ნიშნავს რომ სიმბოლოს შემდეგ დაწერილი კოდი კონსოლში უნდა შეიყვანო და "enter"-ს დააჭირო.
    </p>
