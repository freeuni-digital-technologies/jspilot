...
export function generateTests(CONFIG) {
    ...
    იმის მსგავს სამუშაო გარემოს, რომელსაც "ნამდვილი" პროგრამისტები იყენებენ`)
        it(`ყველა დავალება გულისხმობს, რომ ხანის აკადემიის სავალდებულო ვიდეოები/სავარჯიშოები, რომელიც 
        დალინკულია წინა სემინარებში, გავლილი გაქვს დამოუკიდებლად. ამის გარეშე დავალებას თავს ვერ გაართმევ.`)
        it(`ყურადღებით მიყევი ხოლმე ინსტრუქციას და არაფერს გადაახტე, რადგან
    მეილზე ინფორმაციის სათითაოდ ყველასთვის გამეორებას არ ვაპირებთ`)
        it(`ყველა დავალებას ექნება ხოლმე ტესტები.`)
        it(`ეს ხაზი, მარცხნივ ✅ ნიშანით, არის ტესტის მაგალითი. როდესაც 
        რაღაც იქნება ხოლმე გასაკეთებელი, თავიდან გაწითლდება. ხშირად, რომელიმე გვერდზე სტუდენტები
        მხოლოდ გაწითლებულ ტექსტს კითხულობენ. არადა, წინა ხაზებში გვაქვს ხოლმე ახსნა/მაგალითი იმის, რაც უნდა 
        გააკეთო. ეს დავალებები ტექნიკურად რთული არაა, მაგრამ ეგრე ზერელედ თუ მიუდგები, ძალიან დიდ დროს წაგართმევს.
        თუ კოდი ტესტზე "გადის", მაშინ გამოჩნდება ხოლმე"შემდეგი ნაბიჯის" ღილაკი, როგორც ახლა მარჯვნივ. 
        ჯერ არ დააჭირო, წაიკითხე ბოლომდე`,
    ...
    უკვე ნაჩვენებია). შენ თვითონ დაარეგულირე რამდენად ხშირად გამოიყენებ მინიშნებებს 
    (და მაგის მაგივრად, მაგალითად, დაგუგლავ ან სემინარში მოძებნი პასუხს`)
    ...
    CONFIG.isStep(steps.header) && describe(`header`, () => {
        ...
        it(`head ელემენტში შექმენი title თეგი შეცვალე და შენი საიტის სახელი ჩაწერე. საიტს რამე თემა მოუფიქრე 😎`, () => {
            let title = document.querySelector("head > title");
            expect(title).to.exist
            let text = title.innerText;
            expect(text).to.have.lengthOf.above(0)
            expect(text).not.equal('დავალება 5')
        })
